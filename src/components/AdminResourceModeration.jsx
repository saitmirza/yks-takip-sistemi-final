...
import { CheckCircle, X, AlertCircle, Clock, Trash2, Eye, FileText } from 'lucide-react';
        ...
        <div className="w-full pb-24 space-y-6">
            ...
            <div className="grid grid-cols-3 gap-3">
                <div className="bg-white dark:bg-gray-900 rounded-2xl p-4 border border-slate-200 dark:border-gray-700 text-center">
                    <p className="text-2xl font-bold text-amber-600 dark:text-amber-400">{pendingResources.length}</p>
                    <p className="text-xs text-slate-600 dark:text-gray-400 font-bold uppercase">Beklemede</p>
                </div>
                <div className="bg-white dark:bg-gray-900 rounded-2xl p-4 border border-slate-200 dark:border-gray-700 text-center">
                    <p className="text-2xl font-bold text-slate-600 dark:text-gray-400">0</p>
                    <p className="text-xs text-slate-600 dark:text-gray-400 font-bold uppercase">Incelenyor</p>
                </div>
                <div className="bg-white dark:bg-gray-900 rounded-2xl p-4 border border-slate-200 dark:border-gray-700 text-center">
                    <p className="text-2xl font-bold text-slate-600 dark:text-gray-400">0</p>
                    <p className="text-xs text-slate-600 dark:text-gray-400 font-bold uppercase">Reddedilen</p>
                </div>
            </div>
            ...
            {loading ? (
                ...
                <div className="bg-white dark:bg-gray-900 rounded-2xl border border-slate-200 dark:border-gray-700 p-12 text-center">
                    ...
                    <p className="font-bold text-slate-800 dark:text-white mb-1">Tüm dosyalar onaylandı! 🎉</p>
                    <p className="text-sm text-slate-500 dark:text-gray-400">Yeni dosya gelene kadar bekliyoruz.</p>
                </div>
            ) : (
